...
///
/// search·recent·analyze 를 단일 저장소로 통합한다.
/// 기존 [SearchHistoryRepository](String 기반)는 티켓 6에서 이 인터페이스로 흡수된다.
///
...
abstract interface class FoodRepository {
  ...
  /// 자유 텍스트 음식명을 입력받아 신호등 판정 결과를 반환한다.
  ///
  /// 대응 API: POST /foods/analyze { "text": [text] }
  /// 서버 부재 중(W3)에는 Mock 구현이 주입된다.
  Future<EatVerdict> analyze(String text);

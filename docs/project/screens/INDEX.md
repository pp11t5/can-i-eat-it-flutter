...
| 02 | 로그인 (카카오) | `/login` | P0 | 미착수 | — |
| 02a | 삭제 유예 안내 | `/login?mode=deleted` | P0 | 미착수 | — |
| 03 | 약관 동의 | `/terms` | P0 | 미착수 | — |
...
| ID | 화면명 | 라우트 | 우선순위 | 상태 | Figma node |
|---|---|---|---|---|---|
| 04 | 온보딩 인트로 | `/onboarding/intro` | P0 | 미착수 | — |
| 05 | 질환 선택 (1/4) | `/onboarding/condition` | P0 | 미착수 | — |
| 06 | 증상 빈도 + 심각도 (2/4) | `/onboarding/frequency` | P0 | 미착수 | — |
| 07 | 트리거 음식 (3/4) | `/onboarding/triggers` | P0 | 미착수 | — |
| 08 | 알레르기·복용약 (4/4) | `/onboarding/medications` | P0 | 미착수 | — |
| 09 | 온보딩 완료 | `/onboarding/done` | P0 | 미착수 | — |
